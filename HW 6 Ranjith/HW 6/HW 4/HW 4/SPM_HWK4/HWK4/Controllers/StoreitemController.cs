...
namespace HWK4.Controllers
{
    ...
    public class StoreitemController : ControllerBase
    {
        ...
        public IActionResult UpdateStoreitem([FromBody]Storeitems Storeitem)
        {
            if (Storeitem == null)
            {
            ...
            //Storeitems dbStoreitems = _StoreitemRepository.GetStoreitem(Storeitem.Id);
            //if (dbStoreitems == null) {
            //    return BadRequest("Noto found");
            //}
            //dbStoreitems.Description = Storeitem.Description;
            //dbStoreitems.IsCompleted = Storeitem.IsCompleted;
